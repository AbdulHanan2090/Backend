...
class Customer(models.Model):
    ...
    #---------------- Pills ------------------------
    pills_1=models.IntegerField(blank=True,null=True,default=0)
    pills_2=models.IntegerField(blank=True,null=True,default=0)
    pills_3=models.IntegerField(blank=True,null=True,default=0)
    pills_4=models.IntegerField(blank=True,null=True,default=0)
    pills_5=models.IntegerField(blank=True,null=True,default=0)
    pills_6=models.IntegerField(blank=True,null=True,default=0)
    pills_7=models.IntegerField(blank=True,null=True,default=0)
    pills_8=models.IntegerField(blank=True,null=True,default=0)